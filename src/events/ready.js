...
module.exports.run = async (client) =>
{
    ...
    console.log(white(`✅ [INFO]: Porting over: ${client.users.cache.size} Users & ${client.guilds.cache.size} Servers`));
    client.user.setPresence({ activities: [{ name: `Electra is back!` }], status: "dnd" });
};